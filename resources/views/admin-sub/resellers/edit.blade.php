...
<body class="bg-gray-50 flex min-h-screen">
    ...
    <main class="md:pl-72 pt-20 w-full p-6">
        <div class="flex items-center mb-8">
            <h2 class="text-4xl font-extrabold tracking-tight text-blue-500 flex items-center">
                <i class="fas fa-user-edit w-8 h-8 mr-5 text-blue-500"></i>Edit Reseller
            </h2>
        </div>

        <div class="bg-white rounded-2xl shadow-lg border border-blue-200 border-t-4 border-t-blue-400 p-6">
            <form class="grid grid-cols-1 md:grid-cols-2 gap-8" action="{{ route('resellers.update', $reseller->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" required
                                value="{{ old('nama_lengkap', $reseller->nama_lengkap) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="no_identitas" required
                                value="{{ old('no_identitas', $reseller->no_identitas) }}"
                                class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200">
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700 mb-1">Telepon</label>
                            <input type="text" name="telepon" required
                                value="{{ old('telepon', $reseller->telepon) }}"
                                class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200">
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700 mb-1">Alamat Lengkap</label>
                            <textarea name="alamat" rows="3" required
                                class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200">{{ old('alamat', $reseller->alamat) }}</textarea>
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700 mb-1">Username Login</label>
                            <input type="text" name="username" required
                                value="{{ old('username', $reseller->username) }}"
                                class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="tgl_bergabung" name="tgl_bergabung" required
                                value="{{ old('tgl_bergabung', $reseller->tgl_bergabung ? $reseller->tgl_bergabung->format('Y-m-d') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="limit_hutang"
                                value="{{ old('limit_hutang', $reseller->limit_hutang ?? 0) }}"
                                class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200">
                        </div>
                        <div>
                            <label class="block font-medium text-gray-700 mb-1">Kode Unik</label>
                            <input type="number" name="kode_unik" min="0" max="9999"
                                value="{{ old('kode_unik', $reseller->kode_unik ?? 0) }}"
                                class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200">
                        </div>
                    </div>
                </div>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <div class="space-y-2 pl-2 text-gray-700">
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_router[]" value="ALL"
                                        {{ in_array('ALL', (array) $reseller->hak_akses_router) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    Semua Router
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_router[]" value="NONE"
                                        {{ in_array('NONE', (array) $reseller->hak_akses_router) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    Tidak Ada
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_router[]" value="1"
                                        {{ in_array('1', (array) $reseller->hak_akses_router) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    SERVER BNC
                                </label>
                            </div>
                        ...
                        <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <div class="space-y-2 pl-2 text-gray-700">
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_server[]" value="ALL"
                                        {{ in_array('ALL', (array) $reseller->hak_akses_server) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    Semua Server
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_server[]" value="NONE"
                                        {{ in_array('NONE', (array) $reseller->hak_akses_server) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    Tidak Ada
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_server[]" value="1"
                                        {{ in_array('1', (array) $reseller->hak_akses_server) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    hotspot1
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_server[]" value="2"
                                        {{ in_array('2', (array) $reseller->hak_akses_server) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    server1
                                </label>
                            </div>
                        ...
                        <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
                            ...
                            <div class="space-y-2 pl-2 text-gray-700">
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_profile[]" value="ALL"
                                        {{ in_array('ALL', (array) $reseller->hak_akses_profile) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    Semua Profile
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_profile[]" value="NONE"
                                        {{ in_array('NONE', (array) $reseller->hak_akses_profile) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    Tidak Ada
                                </label>
                                ...
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_profile[]" value="2"
                                        {{ in_array('2', (array) $reseller->hak_akses_profile) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    10Mbps
                                </label>
                                ...
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_profile[]" value="1"
                                        {{ in_array('1', (array) $reseller->hak_akses_profile) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    YYYYY
                                </label>
                                <label class="flex items-center gap-2">
                                    <input type="checkbox" name="hak_akses_profile[]" value="3"
                                        {{ in_array('3', (array) $reseller->hak_akses_profile) ? 'checked' : '' }}
                                        class="accent-blue-500 scale-110">
                                    vc1
                                </label>
                            </div>
    ...
    <script>
        flatpickr(".tanggal", {
            ...
            altFormat: "d-m-Y",
            theme: "light",
            defaultDate: "{{ old('tgl_bergabung', $reseller->tgl_bergabung ? $reseller->tgl_bergabung->format('Y-m-d') : '') }}"
        });
    </script>
