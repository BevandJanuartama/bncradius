  ...
  <main class="md:pl-72 pt-20 w-full p-6">
    <div class="flex items-center mb-8">
      <h2
        ...
        <i class="fa-solid fa-pen-to-square w-8 h-8 mr-5 text-blue-500"></i>Edit Paket
      </h2>
    </div>

    <div class="bg-white rounded-xl shadow-md border border-blue-400 border-t-4 border-t-blue-500 p-6">
      <form action="{{ isset($paket) ? route('paket.update', $paket->id) : route('paket.store') }}" method="POST"
        ...
        <div>
          ...
          <input type="number" name="harga_bulanan"
            value="{{ old('harga_bulanan', $paket->harga_bulanan ?? '') }}"
            class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200" />
        </div>

        <div>
          <label class="block font-medium mb-1">Harga Tahunan</label>
          <input type="number" name="harga_tahunan"
            value="{{ old('harga_tahunan', $paket->harga_tahunan ?? '') }}"
            class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200" />
        </div>

        <div>
          <label class="block font-medium mb-1">Mikrotik</label>
          <input type="number" name="mikrotik"
            value="{{ old('mikrotik', $paket->mikrotik ?? '') }}"
            class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200" />
        </div>

        <div>
          <label class="block font-medium mb-1">Langganan</label>
          <input type="number" name="langganan"
            value="{{ old('langganan', $paket->langganan ?? '') }}"
            class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200"" />
        </div>
        ...
        <div>
          ...
          <input type="number" name="voucher"
            value="{{ old('voucher', $paket->voucher ?? '') }}"
            class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200" />
        </div>

        <div>
          <label class="block font-medium mb-1">User Online</label>
          <input type="number" name="user_online"
            value="{{ old('user_online', $paket->user_online ?? '') }}"
            class="w-full border border-gray-500 rounded-lg px-3 py-2 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-400 focus:shadow-lg transition duration-200" />
        </div>
